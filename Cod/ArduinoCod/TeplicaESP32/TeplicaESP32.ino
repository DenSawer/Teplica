...
//----------------------------DEFINE----------------------------
#define lighting 14  // освещение
#define heating 12   // нагрев
#define cooling 13   // охлаждение

#define photoresistor 36 // пин фоторезистора pin GIOP36 (ADC0)

#define DHTPIN 17       // пин в который подключен DHT
