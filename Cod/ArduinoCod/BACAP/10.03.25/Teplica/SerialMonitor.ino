void SerialMonitor() {
  ...
  Serial.println(data.lightLevel);  // Вывод значения фоторезистора
  Serial.print("Temperature: ");
  Serial.print(data.airTemp);  // Вывод температуры
  Serial.println(" *C");
  Serial.print("Humidity: ");
  Serial.print(data.airHum);  // Вывод влажности
  Serial.println(" %");
  Serial.print("Soil Moisture: ");
  Serial.println(data.soilMois);  // Вывод влажности почвы
  //printCPULoad();
  Serial.println("--------------------");
}
